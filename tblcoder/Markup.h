...
public:
	...
	//[CMARKUPDEV
	bool RemoveAttrib( LPCTSTR szAttrib ) { return x_RemoveAttrib(m_iPos,szAttrib); };
	bool RemoveChildAttrib( LPCTSTR szAttrib ) { return x_RemoveAttrib(m_iPosChild,szAttrib); };
...
protected:
	...
	//[CMARKUPDEV
	bool x_RemoveAttrib( int iPos, LPCTSTR szAttrib );
